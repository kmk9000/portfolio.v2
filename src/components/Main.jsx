  ...
  return (
    ...
    >
      ...
      <Typography variant="body2" gutterBottom sx={{ color: "#cbd5e1" }}>
        ...
        aesthetically pleasing. My expertise extends to modern frameworks like
        React, allowing me to build dynamic and interactive interfaces. I am
        dedicated to writing clean, maintainable code and continuously learning
        new technologies to stay at the forefront of web development trends.
      </Typography>
      <Typography variant="body2" gutterBottom>
        This porfolio was made with React and Material UI, and is designed to be
        responsive and visually appealing. The project section includes tabs for
        different categories of projects, and each tab contains a description of
        the project and a preview image. The project section is also designed to
      ...
      <Typography variant="body2" gutterBottom sx={{ color: "#cbd5e1" }}>
        My email address is{" "}
        <a href="mailto:kallekoivuniemi@gmail.com<" className="text-cyan-300">
